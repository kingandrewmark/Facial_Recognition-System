...
class Attendance:
    def __init__(self,root):
        ...
        f_lbl.place(x=0,y=15,width=800,height=200)
        ...
        f_lbl.place(x=800,y=15,width=800,height=200)
        ...
        title_lbl=Label(text="ATTENDANCE MANAGEMENT SYSTEM",font=("Sans Serif",35,"bold"),bg="white",fg="darkgreen")
        ...
        btn_frame.place(x=0,y=250,width=580,height=70)
